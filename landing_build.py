...
봅니다. 끝난 테스트 48건을 실측했을 때 테스터는 평균 14일 중 8.8일만 앱을
  ...
  <li>14일 뒤 프로덕션 신청 — <a href="{g('production-form')}">설문 9문항</a>은 미리 읽어 두세요.</li>
            ...
            faq=[
                ('테스터가 14일 동안 매일 앱을 열어야 하나요?',
                 '아닙니다. 구글은 옵트인 상태가 14일 이어졌는지를 봅니다. 실측 48건에서 테스터는 평균 8.8일만 열었고 심사는 통과했습니다.'),
...
14 days</b>. Across 48 finished tests, testers opened the app on 8.8 of 14 days on
...
对 48 次已完成的测试实测，测试者平均只在 14 天里打开了 8.8 天，审核照样通过。
...
<ol class="steps">
  ...
  <li>14 天后申请正式版 — 先读一读<a href="{g('production-form')}">那 9 个问题</a>。</li>
            ...
            faq=[
                ('测试者必须连续 14 天每天打开应用吗？',
                 '不必。Google 看的是加入状态是否持续 14 天。实测 48 次中测试者平均只打开 8.8 天，审核通过。'),
                ('12 人里有人中途退出，要从头再来吗？',
...
對 48 次已完成的測試實測，測試者平均只在 14 天裡打開了 8.8 天，審核照樣通過。
  ...
  <li>14 天後申請正式版 — 先讀一讀<a href="{g('production-form')}">那 9 個問題</a>。</li>
            ...
            faq=[
                ('測試者必須連續 14 天每天打開應用程式嗎？',
                 '不必。Google 看的是加入狀態是否持續 14 天。實測 48 次中測試者平均只打開 8.8 天，審核通過。'),
                ('12 人裡有人中途退出，要從頭再來嗎？',
